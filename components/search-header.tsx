        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="flex items-center gap-3 p-3">
            <Link href="/" className="shrink-0 flex items-center gap-2">
              ...
              />
              <h1 className="text-xl md:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 whitespace-nowrap cursor-pointer hover:opacity-80 transition-opacity hidden sm:block">
                Luo Music Store
              </h1>
            </Link>
            ...
            <form onSubmit={handleSearch} className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-11 pr-4 h-11 bg-gray-50/80 border-gray-200 rounded-xl text-sm focus-visible:ring-blue-500"
              />
            </form>
