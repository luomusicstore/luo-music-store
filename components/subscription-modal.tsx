...
export function SubscriptionModal({ open, onOpenChange, userId, userEmail }: SubscriptionModalProps) {
  const [phone, setPhone] = useState("")
  const [selectedPlan, setSelectedPlan] = useState<"day" | "week" | "month">("month")
  ...
  const activateSubscription = async (callbackData: any) => {
    try {
      ...
      const planAmount = selectedPlan === "day" ? 1000 : selectedPlan === "week" ? 2000 : 4000
  ...
  const handleSubscribe = async () => {
    ...
    try {
      ...
      const amount = selectedPlan === "day" ? 1000 : selectedPlan === "week" ? 2000 : 4000
      const description =
        selectedPlan === "day"
      ...
      const response = await requestPayment(formattedPhone, amount, description)
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[340px] p-4 bg-gradient-to-b from-green-50 to-white border-green-200">
        ...
        <DialogDescription className="sr-only">
          Subscribe to unlock unlimited downloads for UGX 5,000 per month
        </DialogDescription>
          ...
          {paymentStatus === "idle" && (
            <>
              <div className="flex gap-2">
                ...
                >
                  <div className="text-center">
                    <p className="text-base font-bold text-gray-900">4,000</p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-3 border border-green-200">
                <div className="text-center">
                  <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">
                    {selectedPlan === "day" ? "UGX 1,000" : selectedPlan === "week" ? "UGX 2,000" : "UGX 4,000"}
                  </p>
                  <p className="text-xs text-gray-600">
                    {selectedPlan === "day" ? "per day" : selectedPlan === "week" ? "per week" : "per month"}
                  </p>
                </div>
              </div>

              <div className="space-y-1.5 bg-white rounded-lg p-3 border border-gray-200">
