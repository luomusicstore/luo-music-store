...
interface Video {
  ...
  audioUrl?: string
  viewCount?: number
  uploadedAt?: any // Added uploadedAt type
}
...
export default function MoviesPage() {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const q = query(collection(db, "content"), where("categories", "array-contains", "movies"))
        ...
        querySnapshot.forEach((doc) => {
          ...
          fetchedVideos.push({
            ...
            uploadedAt: data.uploadedAt, // Added uploadedAt field
          })
        })
