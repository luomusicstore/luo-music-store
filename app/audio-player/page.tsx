...
export default function AudioPlayerPage() {
      ...
      try {
        ...
        const audios: RelatedAudio[] = querySnapshot.docs
          .map((doc) => {
            ...
            const hasAudioCategory = data.categories && Array.isArray(data.categories) && data.categories.includes("audio")
  ...
  const handleDownload = () => {
    ...
    const downloadUrl = currentAudio.audioDownloadUrl || currentAudio.audioUrl
                  ...
                  {currentAudio.isGoogleDrive ? (
                    <div className="space-y-3 mt-4">
                      <GoogleDriveAudioPlayer
                        driveUrl={currentAudio.audioUrl}
                        autoPlay={false}
                        className="w-full"
                      />
